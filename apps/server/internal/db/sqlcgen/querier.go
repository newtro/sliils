...
type Querier interface {
	...
	CreateBotMessage(ctx context.Context, arg CreateBotMessageParams) (Message, error)
	// ---- bot users ---------------------------------------------------------
	...
	// ---- webhooks_incoming --------------------------------------------------
	CreateIncomingWebhook(ctx context.Context, arg CreateIncomingWebhookParams) (WebhooksIncoming, error)
	...
	// ---- webhooks_outgoing --------------------------------------------------
	CreateOutgoingWebhook(ctx context.Context, arg CreateOutgoingWebhookParams) (WebhooksOutgoing, error)
	// Native Pages (M10).
	// ---- pages --------------------------------------------------------------
	...
	DeleteIncomingWebhook(ctx context.Context, id int64) error
	DeleteMyDevice(ctx context.Context, arg DeleteMyDeviceParams) error
	...
	GetSlashCommandForWorkspace(ctx context.Context, arg GetSlashCommandForWorkspaceParams) (SlashCommand, error)
	...
	ListChannelMembers(ctx context.Context, channelID int64) ([]int64, error)
	...
	ListDevicesForPush(ctx context.Context, userID int64) ([]UserDevice, error)
	...
	ListMyDevices(ctx context.Context, userID int64) ([]UserDevice, error)
	...
	ListOutgoingWebhooksForEvent(ctx context.Context, arg ListOutgoingWebhooksForEventParams) ([]WebhooksOutgoing, error)
	ListOutgoingWebhooksForInstallation(ctx context.Context, appInstallationID int64) ([]WebhooksOutgoing, error)
	...
	ListSlashCommandsForWorkspace(ctx context.Context, workspaceID int64) ([]SlashCommand, error)
	...
	RegisterDevice(ctx context.Context, arg RegisterDeviceParams) (UserDevice, error)
	// ---- slash_commands -----------------------------------------------------
	RegisterSlashCommand(ctx context.Context, arg RegisterSlashCommandParams) (SlashCommand, error)
	...
	TouchIncomingWebhook(ctx context.Context, id int64) error
